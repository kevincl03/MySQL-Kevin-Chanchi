...
CREATE TABLE `supplier` (
  ...
  KEY `idSupplierType` (`idSupplierType`),
  CONSTRAINT `supplier_ibfk_1` FOREIGN KEY (`idSupplierType`) REFERENCES `suppliertype` (`idSupplierType`)
...
INSERT INTO `supplier` VALUES (1,2,'Michael Alejandro','Riascos','Fernández',NULL,NULL,'Calle 123, Zona 4','michael.riascos@gmail.com','3136541230','2024-09-18 07:15:00','2024-09-18 07:15:00'),(2,2,'María Fernanda','García','Pérez',NULL,NULL,'Av. Principal 456, Zona 2','maria.garcia@hotmail.com','3207891230','2024-09-18 07:15:00','2024-09-18 07:15:00'),(3,1,NULL,NULL,NULL,'Suministros ABC','8009001001','Calle 5, Zona Industrial','contacto@abc.com','4561237','2024-09-18 07:20:00','2024-09-18 07:20:00'),(4,1,NULL,NULL,NULL,'SurtiFami','8012003004','Avenida Tecnológica 8, Centro','ventas@surtifami.com','4234567','2024-09-18 07:20:00','2024-09-18 07:20:00');
...
CREATE TABLE `suppliertype` (
  `idSupplierType` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `suppliertype` VALUES (1,'Empresa','2024-09-30 13:15:00','2024-09-30 13:15:00'),(2,'Persona','2024-09-30 13:16:00','2024-09-30 13:16:00');
...
-- Dump completed on 2024-09-30 12:53:23
